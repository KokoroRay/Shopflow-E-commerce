...
public class MoneyTests : DomainTestBase
{
    ...
    [InlineData("")]
    [InlineData(" ")]
    public void Constructor_EmptyOrWhitespaceCurrency_ShouldThrowArgumentException(string invalidCurrency)
    {
        // Act & Assert
    ...
    {
        // Act & Assert
        AssertThrows<ArgumentException>(() => new Money(100m, null!), "Currency cannot be empty");
    }
    ...
    public void Addition_DifferentCurrency_ShouldThrowInvalidOperationException()
    {
        ...
        exception.Message.Should().Contain("Cannot add money with different currencies");
    }
    ...
    public void Subtraction_DifferentCurrency_ShouldThrowInvalidOperationException()
    {
        ...
        // Act & Assert
        var exception = Assert.Throws<InvalidOperationException>(() => money1 - money2);
        exception.Message.Should().Contain("Cannot subtract money with different currencies");
    }
    ...
    public void CompareTo_DifferentCurrency_ShouldThrowInvalidOperationException()
    {
        ...
        exception.Message.Should().Contain("Cannot compare money with different currencies");
    }
